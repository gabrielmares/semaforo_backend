        ...
        pool.get(async function (err, db) {
            ...
            new Promise((resolve, reject) => {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    return new Promise((resolve, reject) => {
                        db.query(`select NOMBRE as EdoNacimiento from cntry_estrucpolitica where ESTADO=${NACESTADO} and municipio=0 and poblacion=0`, function (err, col) {
                            if (err) {
                                reject(err)
                            }
